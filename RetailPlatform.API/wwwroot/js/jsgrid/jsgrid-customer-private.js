    ...
    $("#batchDelete").jsGrid({
        ...
        controller: {
            ...
            updateItem: function (item) {
                return $.ajax({
                    type: "GET",
                    url: "/Customer/EditPrivateAccount" + item,
                    data: item,
                    dataType: "json"
                });
            },
            ...
            { name: "city", width: 60, title: "Grad" },
            {
                ...
                itemTemplate: function (value, item) {
                    ...
                    var $customEditButton = $("<button>")
                        ...
                        .text("Edit")
                        .click(function (e) {
                            document.location.href = "/Customer/EditPrivateAccount/" + item.id;
                            e.stopPropagation();
                        });
                    var $customDeleteButton = $("<button>")
                        ...
                        .click(function (e) {
                            ...
                            $('#message').text("Da li zelite da uklonite " + item.fullName + " klijenta?");
                            e.stopPropagation();
                        });
