    ...
    public class MappingProfile : AutoMapper.Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<Add, AddModel>()
                ...
                .ForMember(dest =>
                dest.ImagePath,
                opt => opt.MapFrom(src => $"https://api.compexsale.org{src.ImgUrl1.Trim()}"))
                .ForMember(dest =>
                dest.Status,
                opt => opt.MapFrom(src => src.Active == false ? "Kreiran" : "Aktivan"));
            ...
            CreateMap<Add, ProductPreviewDTO>()
                ...
                .ForMember(dest =>
                dest.ImgUrl1,
                opt => opt.MapFrom(src => src.ImgUrl1 != null ? $"https://api.compexsale.org{src.ImgUrl1.Trim()}" : "/images/icon/default-image.png"))
                .ForMember(dest =>
                dest.ImgUrl2,
                opt => opt.MapFrom(src => src.ImgUrl2 != null ? $"https://api.compexsale.org{src.ImgUrl2.Trim()}" : "/images/icon/default-image.png"))
                .ForMember(dest =>
                dest.ImgUrl3,
                opt => opt.MapFrom(src => src.ImgUrl3 != null ? $"https://api.compexsale.org{src.ImgUrl3.Trim()}" : "/images/icon/default-image.png"))
                .ForMember(dest =>
                dest.ImgUrl4,
                opt => opt.MapFrom(src => src.ImgUrl4 != null ? $"https://api.compexsale.org{src.ImgUrl4.Trim()}" : "/images/icon/default-image.png"))
                .ForMember(dest =>
                dest.Price,
